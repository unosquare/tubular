...
describe('tbEmptyForm', () => {
    ...
    it('should have an empty required field', () => expect($('input[name=CustomerName]').getAttribute('value')).toBe(''));

    it('should not be able to click on save', () => expect($('#btnSave').isEnabled()).toBe(false));
