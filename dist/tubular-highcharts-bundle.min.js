(function(){"use strict";angular.module("tubular-hchart.directives",["tubular.services","highcharts-ng"]).directive("tbHighcharts",[function(){return{template:'<div class="tubular-chart"><highchart config="options"><\/canvas><\/div>',restrict:"E",replace:!0,scope:{serverUrl:"@",title:"@?",requireAuthentication:"=?",name:"@?chartName",chartType:"@?"},controller:["$scope","tubularHttp",function(n,t){n.tubularDirective="tubular-chart";n.dataService=t.getDataService(n.dataServiceName);n.showLegend=n.showLegend||!0;n.chartType=n.chartType||"line";n.options={options:{chart:{type:n.chartType}},title:{text:n.title||"Chart"},xAxis:{categories:[]},yAxis:{},series:[]};n.requireAuthentication=angular.isUndefined(n.requireAuthentication)?!0:n.requireAuthentication;n.loadData=function(){t.setRequireAuthentication(n.requireAuthentication);t.get(n.serverUrl).promise.then(function(t){if(t.Series)n.options.xAxis.categories=t.Labels,n.options.series=t.Series.map(function(n,i){return{name:n,data:t.Data[i]}});else{var i=t.Labels.map(function(n,i){return{name:n,y:t.Data[i]}});n.options.series=[{name:t.SerieName||"Serie 1",data:i}]}},function(t){n.$emit("tbChart_OnConnectionError",t)})};n.$watch("serverUrl",function(t){angular.isDefined(t)&&t!=null&&n.loadData()});n.$watch("chartType",function(t){angular.isDefined(t)&&t!=null&&(n.options.options.chart.type=t)})}]}}])})();
/**
 * highcharts-ng
