...
var tubularTemplateServiceModule = {
    enums: {
        ...
        editorTypes: ['tbSimpleEditor', 'tbNumericEditor', 'tbDateTimeEditor', 'tbDateEditor',
    ...
    generateForm: function(fields, options) {
        ...
        return '<tb-form server-save-method="' + options.SaveMethod + '" ' +
            ...
            '\r\n\t<div>' + 
            '\r\n\t\t<button class="btn btn-primary" ng-click="$scope.$parent.save()" ng-disabled="!$scope.$parent.form.model.$valid()">Save</button>' +
            (options.CancelButton ? '\r\n\t\t<button class="btn btn-danger" ng-click="$scope.$parent.cancel()">Cancel</button>' : '') +
            '\r\n</div>' + 
            '\r\n</tb-form>';
    },
