...
describe('Module: tubular.services', () => {
    ...
    var genColumns = '<tb-columnname="Id"label="Id"column-type="numeric"sortable="true"is-key="true"searchable="false"sort-direction="Ascending"sort-order="1"visible="true"><tb-column-filter></tb-column-filter><tb-column-header>{{label}}</tb-column-header></tb-column><tb-columnname="Name"label="Name"column-type="string"sortable="true"is-key="false"searchable="true"sort-direction=""sort-order="0"visible="true"><tb-column-filter></tb-column-filter><tb-column-header>{{label}}</tb-column-header></tb-column><tb-columnname="Company"label="Company"column-type="string"sortable="true"is-key="false"searchable="true"sort-direction=""sort-order="0"visible="true"><tb-column-filter></tb-column-filter><tb-column-header>{{label}}</tb-column-header></tb-column><tb-columnname="Email"label="Email"column-type="string"sortable="true"is-key="false"searchable="true"sort-direction=""sort-order="0"visible="true"><tb-column-filter></tb-column-filter><tb-column-header>{{label}}</tb-column-header></tb-column><tb-columnname="Phone"label="Phone"column-type="string"sortable="true"is-key="false"searchable="true"sort-direction=""sort-order="0"visible="true"><tb-column-filter></tb-column-filter><tb-column-header>{{label}}</tb-column-header></tb-column><tb-columnname="Birthday"label="Birthday"column-type="date"sortable="true"is-key="false"searchable="false"sort-direction=""sort-order="0"visible="true"><tb-column-filter></tb-column-filter><tb-column-header>{{label}}</tb-column-header></tb-column><tb-columnname="IsOwner"label="IsOwner"column-type="boolean"sortable="true"is-key="false"searchable="false"sort-direction=""sort-order="0"visible="true"><tb-column-filter></tb-column-filter><tb-column-header>{{label}}</tb-column-header></tb-column>';
